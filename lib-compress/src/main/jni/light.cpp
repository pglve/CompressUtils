//
// Created by pinggl on 2019/6/13.
//
...
int mainCompress(
        ...
        bool g,
        /**xform-op*/
        bool hflip, bool vflip, bool transpose, bool transverse, bool rot90, bool rot180, bool rot270,
        /**xform-customFilter*/
        bool custom,
        /**xform-crop*/
...
int thumbnailCompress(unsigned char *jpegBuf, unsigned long jpegSize, const char *output, unsigned long maxSize) {
    ...
    do {
        ...
        if (tjCompress2(tjInstance, imgBuf, width, 0, height, TJPF_BGRX, &jpegBuf_out, &jpegSize_out, inSubsamp,
                        quality, 0) < 0) {
